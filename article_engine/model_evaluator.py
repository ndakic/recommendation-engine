...
EVAL_RANDOM_SAMPLE_NON_INTERACTED_ITEMS = 100  # Top-N accuracy metrics consts


class ModelEvaluator:
    def __init__(self, articles_df, interactions_full_df, interactions_train_df, interactions_test_df):
        self.articles_df = articles_df
        # Indexing by personId to speed up the searches during evaluation
        self.interactions_full_indexed_df = interactions_full_df.set_index('personId')
        self.interactions_train_indexed_df = interactions_train_df.set_index('personId')
        self.interactions_test_indexed_df = interactions_test_df.set_index('personId')
    ...
    def evaluate_model_for_user(self, model, person_id):
        ...
        person_recs_df = model.recommend_items(person_id,
                                               items_to_ignore=self.get_items_interacted(person_id, self.interactions_train_indexed_df),
                                               topn=10000000000)
        hits_at_5_count = 0
        hits_at_10_count = 0
